...
export function BottomNav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-[6.2rem] bg-card border-b border-border z-50 transition-colors duration-300">
      <div className="flex justify-around items-center pt-[38px] h-full max-w-md mx-auto px-4">
        {navItems.map((item) => {
