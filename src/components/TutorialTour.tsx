...
const STEPS: TourStep[] = [
  {
    ...
    body: 'Duey keeps what you owe, what you spend and what you earn in one place — no accounts, no bank logins, everything stays on this phone.',
  ...
  },
  {
    ...
    tip: 'Try a swipe once the tour is done',
  },
  {
    id: 'money',
    route: '/',
  ...
  },
  {
    ...
    route: '/stats',
    icon: BarChart3,
    title: 'Stats shows where it is going',
