...
// The Add-Debt form body, split out of AddDebtDialog so it can be code-split.
//
// This file is the ONLY thing in the app that pulls react-hook-form + zod +
// @hookform/resolvers, and together those are ~80 KB of the boot bundle — paid on every cold
// start for a dialog most launches never open. Keeping the dialog chrome (trigger, frame,
// header) eager and this body lazy means the + FAB still opens instantly on the first frame,
// while the validation stack loads in the background right after boot (prefetch.ts tier 1).
